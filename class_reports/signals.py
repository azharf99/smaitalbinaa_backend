...
def log_class_report_change(sender, instance, created, **kwargs):
    """
    Create a notification when a Class Report is created or updated.
    """
...
def log_class_report_deletion(sender, instance, **kwargs):
    """
    Create a notification when a Class Report is deleted.
    """
    user = get_current_user()
    if not user:
        return
